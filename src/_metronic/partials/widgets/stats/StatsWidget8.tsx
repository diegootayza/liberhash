...
const StatsWidget8 = ({ className, innerPadding = '' }: Props) => {
    ...
    return (
        <div className={`card card-custom ${className}`}>
            ...
            <div className={`card-body ${innerPadding}`}>
                <div className="carousel carousel-custom slide" id="widget8_carousel" data-bs-ride="carousel" data-bs-interval="8000" ref={carouselRef}>
                    {/* begin::Heading */}
