...
const StatsWidget6 = ({ className, innerPadding = '', children }: any) => {
    return (
                ...
                <div className="pt-9">
                    ...
                    <div className="row">
                        <div className="col me-n2 mb-5">
                            ...
                            >
                                <KTSVG className="svg-icon-2x ms-n1" path="/media/icons/duotune/general/gen002.svg" />{' '}
                        ...
                        <div className="col mb-5">
                            ...
                            >
                                <KTSVG className="svg-icon-2x ms-n1" path="/media/icons/duotune/general/gen005.svg" />{' '}
