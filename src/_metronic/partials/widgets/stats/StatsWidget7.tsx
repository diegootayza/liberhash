...
const StatsWidget7 = ({ className, innerPadding = '' }: Props) => {
            ...
            <div className={`card-body ${innerPadding}`}>
                ...
                <div className="mb-10">
                    ...
                    <div className="row" data-kt-control="toggle-buttons">
                        ...
                        >
                            <KTSVG path="/media/icons/duotune/electronics/elc007.svg" className="svg-icon-2x me-1" />
                        ...
                        >
                            <KTSVG path="/media/icons/duotune/ecommerce/ecm002.svg" className="svg-icon-2x me-1" />
