        ...
        >
            <div className="container-xxl px-10 py-10">
                ...
                <div className="modal-body">
                    {/*begin::Stepper */}
                    <div ref={stepperRef} className="stepper stepper-1 d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper">
                        {/*begin::Aside */}
                        ...
                        <div className="d-flex flex-row-fluid justify-content-center">
                            {/*begin::Form */}
                            <form className="pb-5 w-100 w-md-400px w-xl-500px" noValidate id="kt_modal_create_app_form">
                                {/*begin::Step 1 */}
                                ...
                                <div className="pb-5" data-kt-stepper-element="content">
                                    <div className="w-100">
                                        ...
                                        {/*begin::Form Group */}
                                        <div className="fv-row">
                                            <label className="fs-6 fw-bolder text-dark mb-7">Select your app framework</label>
                                ...
                                <div className="pb-5" data-kt-stepper-element="content">
                                    <div className="w-100">
                                        ...
                                        {/*begin::Form Group */}
                                        <div className="fv-row mb-12">
                                            <label className="fs-6 fw-bolder text-dark form-label">App Databse Name Name</label>
                                            <input
                                                type="text"
                                                className="form-control form-control-lg form-control-solid"
                                                name="dbname"
                                        ...
                                        {/*begin::Form Group */}
                                        <div className="fv-row">
                                            <label className="fs-6 fw-bolder text-dark mb-7">Select your app database solution</label>
                                ...
                                <div className="pb-5" data-kt-stepper-element="content">
                                    <div className="w-100">
                                        ...
                                        {/*begin::Form Group */}
                                        <div className="fv-row">
                                            <label className="fs-6 fw-bolder text-dark mb-7">Select your app storage solution</label>
                                ...
                                <div className="pb-5" data-kt-stepper-element="content">
                                    <div className="w-100">
                                        ...
                                        <div className="pb-10 pb-lg-15">
                                            ...
                                            <div className="text-muted fw-bold fs-3">Review your setup to kickstart your app!</div>
                                        </div>
                                        {/* end::Heading */}
                                ...
                                <div className="d-flex justify-content-between pt-10">
                                    ...
                                    <div>
                                        <button
                                            ...
                                            onClick={submit}
                                        >
                                            Submit <KTSVG path="/media/icons/duotune/arrows/arr064.svg" className="svg-icon-3 ms-2" />
                                        </button>
                                        ...
                                        <button
                                            ...
                                            onClick={nextStep}
                                        >
                                            Next Step <KTSVG path="/media/icons/duotune/arrows/arr064.svg" className="svg-icon-3 ms-1" />
                                        </button>
                                    </div>
                                </div>
                                {/*end::Actions */}
